	...
	// Create a list of TableRow objects to hold the data for the cloud services
		                                ...
		                                .Select(x => x.HasData ? x.Data : null).Where(x => x != null))
        {
            ...
            var tr = new TableRow(
                ...
                // Note: Because most LINQpad control constructors expect parameters that inherit from Control, the way around this
...
public class TogglePanel
{
    ...
    {
        _state = !startHidden;
        // create the open control. CssClass arrow-down is what's used by Linqpad's internal type display system.
        _open = new Hyperlink(label, ToggleClick) { Visible = !_state, CssClass = "arrow-down" };
        // create the close control. CssClass arrow-up is what's used by Linqpad's internal type display system.
    ...
    // Any class that defines a public ToDump method is called when LINQpad dumps it, 
    // and you can customize the display this way.
